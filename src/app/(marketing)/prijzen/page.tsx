...
const VARIANTS = [
  ...
  },
  {
    ...
    features: [
      'GPS-avontuur voor 2 t/m heel gezin',
      'Familie & Koppel Geluksscore',
      'AI Buddy-begeleiding (warm & verbindend)',
      'Romantische én gezinsroutes beschikbaar',
      'Foto-opdrachten samen',
      'Deelbaar herinneringsrapport',
    ],
    cta: 'Boek Familie & Koppels',
  },
  {
    icon: Shield,
    slug: 'jeugdtocht',
