...
export const metadata: Metadata = {
  ...
  description:
    'Artikelen over sociale impact, teamgeluk en de toekomst van teambuilding — geschreven vanuit 25+ jaar ervaring in commercie, sociaal domein en GPS-innovatie.',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-[#F8FAFC] border-b border-[#E2E8F0] px-4 md:px-8 py-14 md:py-20">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest mb-3">Blog</p>
          <h1
            className="text-3xl md:text-5xl font-black text-[#0F172A] mb-4"
            style={{ fontFamily: 'var(--font-display, "Barlow Condensed", sans-serif)' }}
          >
            Inzichten over teambuilding met impact
          </h1>
          <p className="text-[#64748B] text-sm leading-relaxed">
            Vanuit de praktijk van GPS-innovatie, sociaal ondernemerschap en 25+ jaar commerciële ervaring.
          </p>
        </div>
      </section>
