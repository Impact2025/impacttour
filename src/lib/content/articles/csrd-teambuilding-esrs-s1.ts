...
export const article: Article = {
  slug: 'csrd-teambuilding-esrs-s1',
  category: 'kennisbank',
  title: 'CSRD en de ESRS S1-rapportage van teambuilding: een praktijkgids voor HR',
  description:
  ...
  heading: 'CSRD en de ESRS S1-rapportage van teambuilding: een praktijkgids voor HR',
  image: '/images/articles/csrd-teambuilding-esrs-s1.png',
  keywords: ['CSRD teambuilding', 'ESRS S1 medewerkersbetrokkenheid', 'CSRD sociale impact rapportage', 'ESRS S3 corporate volunteering'],
  cluster: 'fiscaal-compliance',
  publishedAt: '2026-02-03',
  updatedAt: '2026-07-02',
  readingTimeMin: 9,
  cta: 'weareimpact',
  relatedSlugs: ['wkr-teambuilding-2026', 'corporate-volunteering-jaarlijks-programma', 'maatschappelijk-teamuitje-organiseren'],
  body: `
...
| ESRS-datapunt | Hoe je teambuilding rapporteert |
| --- | --- |
| S1-1 — Policies | Beleidsparagraaf met doelen: engagement, vaardigheden, welzijn, inclusie |
| S1-2 — Engagement processes | Co-design met medewerkers en OR, surveys over deelname |
| S1-4 — Actions & management | Positioneer als kernactie binnen ontwikkelprogramma's, met eigenaarschap bij HR |
| S1-5 — Targets | % medewerkers dat jaarlijks deelneemt aan een impactvol programma |
| S1-13 — Training metrics | Uren in sociale GPS-trajecten meetellen als leeruren (soft skills, projectmanagement) |
...
1. Neem impactvolle teambuildingtrajecten op in de materialiteitsmatrix, onderbouwd met input van medewerkers, OR en lokale gemeenschappen.
2. Leg vast hoe medewerkers meebeslissen over de keuze van maatschappelijke partners — enquête, werkgroep, OR-overleg.
3. Formuleer een streefpercentage: hoeveel medewerkers moet jaarlijks deelnemen aan een impactvol programma?
4. Verbind de actie aan zowel S1 (engagement, leeruren) als S3 (lokale impact) in dezelfde paragraaf, zodat inkoop, uitvoering en rapportage consistent zijn.

Een sociale GPS-tocht is dan niet langer "een leuk uitje geweest" — het is een gedocumenteerd, herhaalbaar HR- en duurzaamheidsinstrument. Wil je dat we samen kijken hoe dit past in jullie rapportagejaar? Neem een kijkje bij [www.WeAreImpact.nl](https://www.weareimpact.nl) of plan een strategische verkenning.
`.trim(),
}
